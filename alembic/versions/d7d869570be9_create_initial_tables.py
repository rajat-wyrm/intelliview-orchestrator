...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_candidates_candidate_id"),
        "candidates",
        ["candidate_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_interview_templates_interview_type"),
        "interview_templates",
        ["interview_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_interview_templates_template_id"),
        "interview_templates",
        ["template_id"],
        unique=False,
    )
